...
public class Unidade2Adapter extends RecyclerView.Adapter<Unidade2Adapter.UnidadeViewHolder>{

    List<Unidade> unidades;

    Unidade2Adapter(List<Unidade> unidades){
    ...
    public void onBindViewHolder(@NonNull UnidadeViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(ctx, UnidadesDetailOffLineActivity.class);
